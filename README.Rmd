...
- Open the Makefile and run the `make clean` can be used to clear all the output files. 
- Subsequently, `make output/table_1.rds` and `output/scatterplot.png` can be run to create the outputs.
